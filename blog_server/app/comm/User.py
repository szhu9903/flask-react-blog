...
class User():
    ...
    def get_user_message(self, zaccount):
        user_module = TableModule('blog_user')
        sql_query = f"{user_module.sql_query_default} where bu_account=%s and bu_delflag=0"
    ...
    def user_info(id):
        sql_query = """
        select
            a.id,a.bu_account,a.bu_username,a.bu_delflag,e.sp_type,
