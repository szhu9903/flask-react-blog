...
import api from '../../api'
import {CLEAR_BLOG_LIST, GET_BLOG_COMMENT, GET_BLOG_DETAIL, GET_BLOG_LIST, GET_BLOG_RECOMMEND, GET_BLOG_TYPE, UPDATE_IS_REPLAY, BLOG_CHANGE} from '../constants'
...
// 更新
const blogChange = (data) => ({type: BLOG_CHANGE, data});
